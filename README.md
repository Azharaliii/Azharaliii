...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=20BEFF&center=true&vCenter=true&width=620&lines=BS+Computer+Science+Specialization+in+(AI)+Student;Data+Science+%26+ML+Enthusiast;Turning+Data+Into+Insights;Problem+Solver+%7C+Builder+%7C+Learner" alt="Typing SVG" />
...
* 🔗 [View Project Repository 🚀](https://github.com/Azharaliii/Titanic-EDA-Kaggale-Data-Set-)

---

### 📚 Guftgu Publications Book Order Analysis
Analyzed real-world book order datasets to uncover regional demand shifts, top-selling genres, and operational business insights for marketing optimization.
* 🛠 `Python` `Pandas` `NumPy` `Business Intelligence`
* 🔗 [View Project Repository 🚀](https://github.com/Azharaliii/GuftguPublications-Book-Order-Data-Analysis-)

---

### 🌍 GDP Per Country Analysis (2020–2025)
Conducted statistical time-series tracking of global GDP trends across multiple nations to visualize global economic shifts and macroeconomic growth patterns.
* 🛠 `Python` `Pandas` `Time Series` `Data Visualization`
* 🔗 [View Project Repository 🚀](https://github.com/Azharaliii/GDP-Per-Country-2020-to-2025-)
...
<p align="center">
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=Azharaliii&theme=github_dark" width="100%" />
</p>
...
* 🤖 **Vanderbilt University** — Agentic AI and AI Agents
* 📊 **UniAthena UK** — Basics of Data Science
* 🧠 **UniAthena UK** — Master ChatGPT
* 🔐 **Microsoft** — Introduction to Computers, OS, and Security
* 🌐 **HEC Pakistan** — IoT for Everyone
* 🎨 **Simplilearn** — Introduction to Figma

---

## 🏆 Achievements & Leadership

* 🥇 **IBA Karachi ProBattle ML Competition** — Represented Sukkur IBA and secured a top 20 rank (19/50 teams).
* 🎓 **PEEF Scholarship** — Awarded merit scholarship for academic excellence.
* 👥 **SISC Sukkur IBA** — Active Executive Member contributing to campus tech culture.
* 🌍 **CS Connect Pakistan** — Appointed as Computer Science Campus Ambassador.
